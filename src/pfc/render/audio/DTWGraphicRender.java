...
public class DTWGraphicRender extends GraphicRender {
	...
	public void renderWaveform(Wave wave, float timeStep, String filename) {
		// for signed signals, the middle is 0 (-1 ~ 1)
				...
				float fwidth = (float) nAmplitudes.length / (float)wave.getWaveHeader().getSampleRate() / timeStep;
