...
Wami.setup = function(callback, id, swfurl) {
	...
	function delegateWamiAPI() {
		...
		Wami.hide = function() {
			...
			var div = document.getElementById("wami-container");
			div.style.width= "0px";
			...
			var div2 = document.getElementById("wami-things");
			
			div2.style.margin = "0";
			//div2.style.padding = "3em";
			
			div2.style.cssFloat = "left";
			div2.style.float = "left";
			div2.style.display = "block-inline";
			//document.getElementById('wami').style.display = "none";
